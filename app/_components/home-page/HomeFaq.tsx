                    ...
                    <ul className="flex flex-col">
                        {
                            FAQs.map(({ question, answer }, index) => (
                                <li key={index} className="group border-b border-gray-200 pr-4">
                                    <div className="hover:text-blue-600 text-gray-800 py-8 flex items-center justify-between gap-6">
