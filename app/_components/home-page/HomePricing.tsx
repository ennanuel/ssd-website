...
export default function Pricing() {
    ...
    return (
        <div className="bg-blue-300/10 px-4 xs:px-6 sm:px-10">
            <div className="min-h-screen mx-auto max-w-[var(--max-width)] pt-[120px] pb-20">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-center gap-y-12 gap-x-4 mt-20">
                    {
                        PRICING.map(({ title, description, price, backgroundColor, features, buttonText }) => (
                            <li key={title} className="group">
                              <Link href="/" className={`${backgroundColor} mx-auto max-w-100 md:max-w-auto flex flex-col p-6 pb-0 rounded-3xl border border-gray-200 group-hover:border-blue-600 group-hover:-translate-y-4`}>
