        ...
        <li key={title} className="peer">
            {
                Boolean(subLinks?.length) ?
                    ...
                    <button 
                        ...
                        className="peer lg:group px-4 xs:px-6 sm:px-10 lg:px-4 w-full lg:w-fit block text-white lg:hover:text-white/80 border-t lg:border-t-0 border-gray-200/20"
                    >
                    ...
                    <Link 
                        ...
                        href={href} 
                        className="lg:group px-4 xs:px-6 sm:px-10 lg:px-4 block text-white hover:text-blue-400 border-t lg:border-t-0 border-gray-200/20"
                    >
