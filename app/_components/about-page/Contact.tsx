...
export default function Contact() {
    ...
    return (
        <section className="bg-blue-300/10 px-4 xs:px-6 md:px-10">
            <div className="mx-auto max-w-[var(--max-width)] min-h-screen pt-30 pb-40 flex flex-col lg:flex-row justify-between gap-20">
                <div className="flex flex-col h-fit pb-6 ;g:sticky top-40">
                ...
                <form action="" className="rounded-4xl bg-white border border-gray-200 p-6 sm:p-10 w-full lg:max-w-[640px] flex flex-col gap-6">
